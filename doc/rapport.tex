...
Commentaires critiques\\
    ...
    notre projet ainsi que le planning final. 
    \\
...
\begin{figure}[H]
    \subfloat \includegraphics[scale=0.3]{illustrations/git.png} 
    \subfloat \includegraphics[scale=0.15]{illustrations/github.png} 
    \centering
\end{figure}
...
affichée et que l’on ne sait pas quelle option est en conflit avec
