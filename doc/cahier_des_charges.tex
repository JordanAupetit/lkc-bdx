...
Il faut qu’un utilisationilisateur puisse détecter son matériel afin de pouvoir
...
confronté au soucis qu’est de trouver la correspondance entre son matériel et
...
L’application doit pouruvoir “gérer les conflits et les dépendances” entre les
...
\section{Mots-clés et description d'un option}
\label{sec:Mots-clés et description d'un option}
