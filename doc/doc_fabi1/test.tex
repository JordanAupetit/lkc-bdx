...
des fonctions dont l'usage est assez générique (elles peuvent être utilisée
dans plein de cas différent et ne sont pas développée juste pour une 
fonctionnalité). Il est donc capital d'effectuer des tests sur ces fonctions
pour tenter de découvrir des comportements erronés ou inattendu 
...
convertir une liste à plusieurs dimension en une liste d'une seule dimension.
\\
