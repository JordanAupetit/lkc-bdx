...
class OptionsInterface(Gtk.Window):
    ...
    def change_interface_conflit(self, radio_type):
        ...
        # print "TESTTTT"
        # print self.items[self.current_option_index].get_value()
        # print radio_type
        # print (self.items[self.current_option_index].get_value() != radio_type) and True
        ...
        if ((self.items[self.current_option_index].get_value() != radio_type) and \
            ...
            for conflit in list_conflicts:
                ...
                if (find and
                    ...
                    nb_valid_conflicts += 1
                else:
                    print "CONFLICT not bool or tristate"

            # print "LIST CONFLICTS ==> ", list_conflicts
            # if list_conflicts != [] and nb_valid_conflicts > 0:
    ...
    def on_menu1_save_as_activate(self, widget):
        ...
        if response == Gtk.ResponseType.OK:
            ...
            config_name = save_as_dialog.get_filename()
