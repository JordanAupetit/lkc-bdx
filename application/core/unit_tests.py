...
class UnitTest(unittest.TestCase):
    ...
    Par la suite, on testera les fonctions avec différentes architectures
    """
    ...
    def test_get_first_option_menu(self):
        ...
        for m in self.menus:
            ...
            if index < -1 or index > (len(self.items) - 1):
                raise Exception("This function return an index out of bounds "
                                "## Index value : " + str(index))
    ...
    def test_get_index_menu_option(self):
        ...
        for i in range(len(self.items) - 1):
            index = utility.get_index_menu_option(i,
                                                  self.items,
                                                  self.top_menus)
